...
mean number of daily steps is `r mean_daily_steps` (note this value is computed
...
```
Using the sum of daily steps data calculated in the previous section, we find the
median number of daily steps is `r median_daily_steps` (note this value is computed
and displayed in-line).
...
The number of intervals in the orginal data set with missing values is `r missing_values`
...
find the mean number of daily steps is `r mean_imputed_daily_steps` (note this value is computed
and displayed in-line).  

This compares to a mean number of daily steps of `r mean_daily_steps` (note this 
...
Using the sum of daily steps data calculated in the previous section which now
includes the imputed data substitued for the days originally without data, we 
find the median number of daily steps is `r median_imputed_daily_steps` (note 
this value is computed and displayed in-line).

This compares to a median number of daily steps of `r median_daily_steps` (note 
